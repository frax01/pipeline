...
py -X utf8 0_tool_fuzzing/build_unified_excel.py

# Backup dei dati vecchi locali
py -X utf8 0_tool_fuzzing/backup_old_fuzzing.py
```
...
py -X utf8 0_tool_fuzzing/backup_old_fuzzing.py --remote --local-only-skip
...
foreach ($ip in $VMS) {
    ...
    scp 0_tool_fuzzing/run_fuzzing.py "tecnico@${ip}:/home/tecnico/Desktop/Pipeline/0_tool_fuzzing/"
...
```bash
nohup python 0_tool_fuzzing/run_fuzzing.py --start <START> --end <END> > fuzzing_output.log 2>&1 &
```
...
```bash
# VM1
nohup python 0_tool_fuzzing/run_fuzzing.py --start 0     --end 7679  > fuzzing_output.log 2>&1 &
# VM2
nohup python 0_tool_fuzzing/run_fuzzing.py --start 7679  --end 15358 > fuzzing_output.log 2>&1 &
# VM3
nohup python 0_tool_fuzzing/run_fuzzing.py --start 15358 --end 23036 > fuzzing_output.log 2>&1 &
# VM4
nohup python 0_tool_fuzzing/run_fuzzing.py --start 23036 --end 30714 > fuzzing_output.log 2>&1 &
# VM5
nohup python 0_tool_fuzzing/run_fuzzing.py --start 30714 --end 38392 > fuzzing_output.log 2>&1 &
# VM6
nohup python 0_tool_fuzzing/run_fuzzing.py --start 38392 --end 46070 > fuzzing_output.log 2>&1 &
# VM7
nohup python 0_tool_fuzzing/run_fuzzing.py --start 46070 --end 53748 > fuzzing_output.log 2>&1 &
# VM8
nohup python 0_tool_fuzzing/run_fuzzing.py --start 53748 --end 61426 > fuzzing_output.log 2>&1 &
# VM9
nohup python 0_tool_fuzzing/run_fuzzing.py --start 61426 --end 69104 > fuzzing_output.log 2>&1 &
```
...
# poi il merge negli analysisAllData/0_tool_fuzzing/
```
