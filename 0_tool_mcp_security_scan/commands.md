...
# 2. Riemerge logicamente tutto il pullFromLocal estraendone le statistiche unificate dentro analysisAllData aggregando le sotto-folders a colpi di extend di JSON array in deep state (somma findings fra server VM diversi)
