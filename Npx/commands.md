...
| VM2 | 10.79.6.133  | mcp-shield          | npx_mcp_shield/run_shield.py                   |
...
```powershell
$IPs = @("10.79.6.132","10.79.6.133","10.79.6.134","10.79.6.136","10.79.6.137","10.79.6.138","10.79.6.139")
...
# VM2 (mcp-shield) - installa mcp-shield
...
nohup python Npx/npx_mcp_scan/run_scan.py --start 0 --reset > npx_scan_output.log 2>&1 &
```

### VM2 - mcp-shield (10.79.6.133)
```bash
ssh tecnico@10.79.6.133
cd ~/Desktop/Pipeline && source ~/pipeline-env/bin/activate
pkill -f 'python.*run_shield.py'; sleep 1
nohup python Npx/npx_mcp_shield/run_shield.py --start 0 --reset > npx_shield_output.log 2>&1 &
```
...
nohup python Npx/npx_mcp_check/run_check.py --start 0 --reset > npx_check_output.log 2>&1 &
```
...
nohup python Npx/npx_mcp_guard/run_guard.py --start 0 --reset > npx_guard_output.log 2>&1 &
```
...
nohup python Npx/npx_mcp_security_scan/run_security_scan.py --start 0 --reset > npx_security_scan_output.log 2>&1 &
```
...
nohup python Npx/npx_mcp_watch/run_watch.py --start 0 --reset > npx_watch_output.log 2>&1 &
```
...
nohup python Npx/npx_fuzzing/run_fuzzing.py --start 0 --reset > npx_fuzzing_output.log 2>&1 &
```
...
# Oppure una singola VM (es. VM2)
scp "C:\Users\francesco\Desktop\pipeline\functions\config.py" tecnico@10.79.6.133:~/Desktop/Pipeline/functions/config.py
```
...
```powershell
# mcp-scan (VM1)
ssh tecnico@10.79.6.132 "cd ~/Desktop/Pipeline && source ~/pipeline-env/bin/activate && pkill -f 'python.*run_scan.py'; sleep 1 && nohup python -u Npx/npx_mcp_scan/run_scan.py --start 0 --reset > Npx/npx_mcp_scan/output.log 2>&1 &"

# mcp-shield (VM2)
ssh tecnico@10.79.6.133 "cd ~/Desktop/Pipeline && source ~/pipeline-env/bin/activate && pkill -f 'python.*run_shield.py'; sleep 1 && nohup python -u Npx/npx_mcp_shield/run_shield.py --start 0 --reset > Npx/npx_mcp_shield/output.log 2>&1 &"

# mcp-check (VM3)
ssh tecnico@10.79.6.134 "cd ~/Desktop/Pipeline && source ~/pipeline-env/bin/activate && pkill -f 'python.*run_check.py'; sleep 1 && nohup python -u Npx/npx_mcp_check/run_check.py --start 0 --reset > Npx/npx_mcp_check/output.log 2>&1 &"

# mcp-guard (VM4)
ssh tecnico@10.79.6.136 "cd ~/Desktop/Pipeline && source ~/pipeline-env/bin/activate && pkill -f 'python.*run_guard.py'; sleep 1 && nohup python -u Npx/npx_mcp_guard/run_guard.py --start 0 --reset > Npx/npx_mcp_guard/output.log 2>&1 &"

# mcp-security-scan (VM5)
ssh tecnico@10.79.6.137 "cd ~/Desktop/Pipeline && source ~/pipeline-env/bin/activate && pkill -f 'python.*run_security_scan.py'; sleep 1 && nohup python -u Npx/npx_mcp_security_scan/run_security_scan.py --start 0 --reset > Npx/npx_mcp_security_scan/output.log 2>&1 &"

# mcp-watch (VM6)
ssh tecnico@10.79.6.138 "cd ~/Desktop/Pipeline && source ~/pipeline-env/bin/activate && pkill -f 'python.*run_watch.py'; sleep 1 && nohup python -u Npx/npx_mcp_watch/run_watch.py --start 0 --reset > Npx/npx_mcp_watch/output.log 2>&1 &"

# fuzzing (VM7)
ssh tecnico@10.79.6.139 "cd ~/Desktop/Pipeline && source ~/pipeline-env/bin/activate && pkill -f 'python.*run_fuzzing.py'; sleep 1 && nohup python -u Npx/npx_fuzzing/run_fuzzing.py --start 0 --reset > Npx/npx_fuzzing/output.log 2>&1 &"
```
...
```powershell
# VM1 - mcp-scan
ssh tecnico@10.79.6.132 "cd ~/Desktop/Pipeline && source ~/pipeline-env/bin/activate && pkill -f 'python.*run_scan.py'; sleep 1 && nohup python -u Npx/npx_mcp_scan/run_scan.py --start -1 > Npx/npx_mcp_scan/output.log 2>&1 &"

# VM2 - mcp-shield
ssh tecnico@10.79.6.133 "cd ~/Desktop/Pipeline && source ~/pipeline-env/bin/activate && pkill -f 'python.*run_shield.py'; sleep 1 && nohup python -u Npx/npx_mcp_shield/run_shield.py --start -1 > Npx/npx_mcp_shield/output.log 2>&1 &"

# VM3 - mcp-check
ssh tecnico@10.79.6.134 "cd ~/Desktop/Pipeline && source ~/pipeline-env/bin/activate && pkill -f 'python.*run_check.py'; sleep 1 && nohup python -u Npx/npx_mcp_check/run_check.py --start -1 > Npx/npx_mcp_check/output.log 2>&1 &"

# VM4 - mcp-guard
ssh tecnico@10.79.6.136 "cd ~/Desktop/Pipeline && source ~/pipeline-env/bin/activate && pkill -f 'python.*run_guard.py'; sleep 1 && nohup python -u Npx/npx_mcp_guard/run_guard.py --start -1 > Npx/npx_mcp_guard/output.log 2>&1 &"

# VM5 - mcp-security-scan
ssh tecnico@10.79.6.137 "cd ~/Desktop/Pipeline && source ~/pipeline-env/bin/activate && pkill -f 'python.*run_security_scan.py'; sleep 1 && nohup python -u Npx/npx_mcp_security_scan/run_security_scan.py --start -1 > Npx/npx_mcp_security_scan/output.log 2>&1 &"

# VM6 - mcp-watch
ssh tecnico@10.79.6.138 "cd ~/Desktop/Pipeline && source ~/pipeline-env/bin/activate && pkill -f 'python.*run_watch.py'; sleep 1 && nohup python -u Npx/npx_mcp_watch/run_watch.py --start -1 > Npx/npx_mcp_watch/output.log 2>&1 &"

# VM7 - fuzzing
ssh tecnico@10.79.6.139 "cd ~/Desktop/Pipeline && source ~/pipeline-env/bin/activate && pkill -f 'python.*run_fuzzing.py'; sleep 1 && nohup python -u Npx/npx_fuzzing/run_fuzzing.py --start -1 > Npx/npx_fuzzing/output.log 2>&1 &"
```
...
```bash
# mcp-scan (VM1)
tail -f ~/Desktop/Pipeline/npx_scan_output.log

# mcp-shield (VM2)
tail -f ~/Desktop/Pipeline/npx_shield_output.log

# mcp-check (VM3)
tail -f ~/Desktop/Pipeline/npx_check_output.log

# mcp-guard (VM4)
tail -f ~/Desktop/Pipeline/npx_guard_output.log

# mcp-security-scan (VM5)
tail -f ~/Desktop/Pipeline/npx_security_scan_output.log

# mcp-watch (VM6)
tail -f ~/Desktop/Pipeline/npx_watch_output.log

# fuzzing (VM7)
tail -f ~/Desktop/Pipeline/npx_fuzzing_output.log
```
...
### Monitoraggio remoto (dal PC locale)
```bash
...
for IP in 10.79.6.132 10.79.6.133 10.79.6.134 10.79.6.136 10.79.6.137 10.79.6.138 10.79.6.139; do
    echo "=== $IP ==="
    ssh tecnico@$IP "ps aux | grep 'run_.*\.py' | grep -v grep | head -1"
done
...
# mcp-shield (VM2)
scp tecnico@10.79.6.133:~/Desktop/Pipeline/Npx/npx_mcp_shield/mcp_shield_stats.json results_npx/
scp tecnico@10.79.6.133:~/Desktop/Pipeline/Npx/npx_mcp_shield/mcp_shield_servers.json results_npx/
...
scp tecnico@10.79.6.133:~/Desktop/Pipeline/Npx/npx_mcp_shield/mcp_shield_*.json results_npx/ && \
