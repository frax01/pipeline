...
def main(start_idx: int, end_idx: int = None, reset: bool = False, excel_path: str = None):
    ...
    print(f"=== Running MCP Security Scan (NPX) ===")
    ...
    for idx in range(start_idx, end_idx):
        ...
        print(f"[mcp-security-scan-npx] {idx}/{end_idx} | nodejs | {_status} | {end_time - start_time:.2f}s | remaining: {remaining}")

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run MCP Security Scan on NPX servers")
