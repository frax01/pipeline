...
TOOLS = {
    ...
    "fuzzing": {
        ...
        "dir": "analysis/fuzzing",
        "script": "fuzzing/run_fuzzing.py",
    ...
    "shield": {
        ...
        "dir": "mcp_shield",
        "script": "mcp_shield/run_shield.py",
    ...
    "security_scan": {
        ...
        "script": "mcp_security_scan/run_security_scan.py",
...
def merge_guard():
    import sys
    module_dir = BASE_DIR / "mcp_guard"
    sys.path.insert(0, str(module_dir))
    from merge_stats import merge_guard_all
    sys.path.pop(0)

    base_pull_dir = BASE_DIR / "pullFromVM"
    out_dir = BASE_DIR / "mcp_guard" / "postprocessing"
...
def merge_shield():
    import sys
    module_dir = BASE_DIR / "mcp_shield"
    sys.path.insert(0, str(module_dir))
    from merge_stats import merge_shield_all
    sys.path.pop(0)

    base_pull_dir = BASE_DIR / "pullFromVM"
    out_dir = BASE_DIR / "mcp_shield" / "postprocessing"
...
def merge_watch():
    import sys
    module_dir = BASE_DIR / "mcp_watch"
    sys.path.insert(0, str(module_dir))
    from merge_stats import merge_watch_all
    sys.path.pop(0)

    base_pull_dir = BASE_DIR / "pullFromVM"
    out_dir = BASE_DIR / "mcp_watch" / "postprocessing"
...
def merge_fuzzing():
    ...
    base_pull_dir = BASE_DIR / "pullFromVM"
    out_dir = BASE_DIR / "fuzzing" / "postprocessing"
...
def merge_scan():
    import sys
    module_dir = BASE_DIR / "mcp_scan"
    sys.path.insert(0, str(module_dir))
    from merge_stats import merge_scan_all
    sys.path.pop(0)
    
    base_pull_dir = BASE_DIR / "pullFromVM"
    out_dir = BASE_DIR / "mcp_scan" / "postprocessing"
...
def merge_security_scan():
    import sys
    module_dir = BASE_DIR / "mcp_security_scan"
    sys.path.insert(0, str(module_dir))
    from merge_stats import merge_security_scan_all
    sys.path.pop(0)

    base_pull_dir = BASE_DIR / "pullFromVM"
    out_dir = BASE_DIR / "mcp_security_scan" / "postprocessing"
...
def merge_check():
    import sys
    module_dir = BASE_DIR / "mcp_check"
    sys.path.insert(0, str(module_dir))
    from merge_stats import merge_check_all
    sys.path.pop(0)

    base_pull_dir = BASE_DIR / "pullFromVM"
    out_dir = BASE_DIR / "mcp_check" / "postprocessing"
