...
>
> I VP sono contati **per contenuto del finding, non per riga**: i worker di
> watch sono stati riavviati su range sovrapposti e il merge dei suoi 50 shard
> ripete lo stesso finding piu' volte (39% di duplicati in watch, ~0% negli
> altri tool e nell'intera prima analisi).
...
| watch | 1,166 | 1,224 | +58 | 650 | 674 | +24 |
...
| **totale** | **27,958** | **24,225** | **-3,733** | **11,841** | **11,487** | **-354** |
