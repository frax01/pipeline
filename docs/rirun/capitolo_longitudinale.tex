...
%    \ref{sec:manual}       -> sez. 8.1.3 "Manual audit results"   (i RISULTATI) ok
%    \ref{sec:manual-method}-> sez. 6.4   "Manual Audit"           (il METODO) ok
%    \ref{ch:discussion}    -> cap. 9    "Discussion" ok
%    \ref{ch:ethics}        -> cap. 11   "Ethical discussion" ok
%    \ref{sec:llm}          -> sez. 10.3 (lo Stage 2B su Ollama/llama3)
%                              usato solo nel file etica_sostituzione.tex
%
%  ATTENZIONE: 6.4 e 8.1.3 sono due punti DIVERSI. 6.4 descrive i criteri con
%  cui si giudica un finding, 8.1.3 riporta l'esito dell'audit. Il capitolo
%  cita entrambi e non vanno collassati sulla stessa label.
% =====================================================================
...
criteria of section~\ref{sec:manual-method} do not cover this case at all: they
were written for secrets committed to a repository, and are simply silent on
