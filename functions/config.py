...
FRAMEWORK_PATHS = {
    ...
    "scanorama": BASE_DIR / "analysis" / "scanorama.json",
    "mcp-validator": BASE_DIR / "analysis" / "mcp-validator.json",
    "proxy": BASE_DIR / "analysis" / "proxy.json",
}
