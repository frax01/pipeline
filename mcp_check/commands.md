...
Prima di tutto, invia l'aggiornamento di `mcp_check` a tutte le 9 macchine:
...
# Aggrega i risultati in */postprocessing/mcp_check
python deploy.py --merge-check
```

I risultati appariranno in `mcp_check/postprocessing/` suddivisi per suite:
