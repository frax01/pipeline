...
python mcp_guard/run_guard.py --start 0 --end 5 --reset
...
nohup python mcp_guard/run_guard.py --start 0 --end 6689 --reset > guard_output.log 2>&1 &
...
# 2. Aggrega tutto in mcp_guard/postprocessing/
...
watch -n 5 'cat ~/Desktop/Pipeline/mcp_guard/mcp_guard_stats.json | python3 -m json.tool'
